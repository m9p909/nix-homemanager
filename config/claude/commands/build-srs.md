...
Create an SRS for: **[PROJECT_NAME]**

Project Description: [INSERT BRIEF PROJECT DESCRIPTION]

Ask me for the project details if not provided above, then systematically work through each section building a comprehensive, professional SRS document that could serve as a contract between developers and stakeholders.
