...
Note: the global CLAUDE.md rule (composition over inheritance, never use inheritance) takes precedence — read LSP violations here as further reasons to avoid inheritance entirely.
